...
const SPEC: &str = "vendor/omnigent-0.3.0/openapi.json";
...
fn codegen() -> Result<()> {
    ...
    if let Err(e) = type_space.add_ref_types(parsed.iter().map(|(n, s)| (n.as_str(), s.clone()))) {
        ...
        let skipped_path = root.join("vendor/omnigent-0.3.0/SKIPPED.md");
...
vendor/omnigent-0.3.0/openapi.json — DO NOT EDIT BY HAND.\n\
#![allow(clippy::all)]\n\n";
