...
| C. Terminal reconnect UX (ring buffer vs blank-on-reconnect) | **Resolved** — Lens-side ring buffer (covers brief reconnects; a deliberate long Sleep reclaims the PTY)                                                                                                                                                                                           | workspace & terminals                |
